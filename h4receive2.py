...
def makedata3(data_layers):
        ...
        fo = open("/home/p4/tutorials/exercises/11linkmonitor/message/lsbepath.txt", "r")  
        for line in fo.readlines():
            if line.strip()=='':
               continue
            line = line.strip()
        ########follows are making for allpathdata for analysis.
        f1 = "/home/p4/tutorials/exercises/linkmonitor/message/allpathdata.txt"
        ...
        f2 = "/home/p4/tutorials/exercises/linkmonitor/message/singledata.txt"
